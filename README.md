# changed by qfdong
I changed some codes to support region layer， reorg layer and connect layer, and it will generate a "_fake" prototxt that can be used in the Visualization website:
http://dgschwend.github.io/netscope/quickstart.html 
The region layer is support in my generator, which is a customer version that I changed from caffe. 
To use the converter, please refer ConvertTinyYoloVoc.sh

# NEXT ARE FROM ORIGIN AUTHOR
